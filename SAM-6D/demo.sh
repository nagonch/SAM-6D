...
python run_inference_custom.py --segmentor_model $SEGMENTOR_MODEL --template_dir $TEMPLATE_DIR --output_dir $OUTPUT_DIR --cad_path $CAD_PATH --rgb_path $RGB_PATH --depth_path $DEPTH_PATH --cam_path $CAMERA_PATH
...
python run_inference_custom.py --output_dir $OUTPUT_DIR --cad_path $CAD_PATH --template_dir $TEMPLATE_DIR  --rgb_path $RGB_PATH --depth_path $DEPTH_PATH --cam_path $CAMERA_PATH --seg_path $SEG_PATH
