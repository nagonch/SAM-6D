...
def run_inference(
    ...
    template_dir = os.path.join(args.template_dir, "templates")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--segmentor_model", default="sam", help="The segmentor model in ISM"
    )
    parser.add_argument(
        "--output_dir", nargs="?", help="Path to root directory of the output"
    )
    parser.add_argument("--template_dir", nargs="?", help="Tempalte_dir")
